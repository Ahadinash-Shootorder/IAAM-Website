...
export interface ApiGeneralGeneral extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Communication: Schema.Attribute.Component<'menus.communication', true>;
    CommunicationTitle: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    Favoicon: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    Legal: Schema.Attribute.Component<'menus.legal-info', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::general.general'
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    WeChat: Schema.Attribute.Component<'menus.we-chat', false>;
  };
}
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    BlogSection: Schema.Attribute.Component<'secondfold.fourth-fold', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    EventSection: Schema.Attribute.Component<
      'event-section.event-section',
      false
    >;
    HeroBanner: Schema.Attribute.Component<'banner.hero-banner', false> &
      Schema.Attribute.Required;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    SecondFold: Schema.Attribute.Component<'secondfold.second-fold', false>;
    ThirdFold: Schema.Attribute.Component<'secondfold.third-fold', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiMenuSectionMenuSection extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    LeftCard: Schema.Attribute.Component<
      ...
      false
    >;
    Links: Schema.Attribute.Component<'menus.menu-links', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
    ...
    > &
      Schema.Attribute.Private;
    MenuPlacement: Schema.Attribute.Enumeration<['Primary', 'Footer']>;
    OrderNo: Schema.Attribute.Integer;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiTopContentTopContent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ParentPage: Schema.Attribute.Enumeration<
      [
        'Individual Page',
        'Membership',
        'Meetings & Events',
    ...
    >;
    publishedAt: Schema.Attribute.DateTime;
    Section: Schema.Attribute.Component<'sections.section-one', true>;
...
export interface ApiVedioVedio extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    CTAButtonLink: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    Description: Schema.Attribute.Blocks;
    DisplayRole: Schema.Attribute.Enumeration<['Admin', 'Public', 'Private']>;
    FeaturedVideo: Schema.Attribute.Boolean;
    HostName: Schema.Attribute.String;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::vedio.vedio'> &
      Schema.Attribute.Private;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    Title: Schema.Attribute.String;
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    VideoCategory: Schema.Attribute.Enumeration<
      [
        'Research Highlights',
        'Keynote Lectures',
        'Panel Discussions',
