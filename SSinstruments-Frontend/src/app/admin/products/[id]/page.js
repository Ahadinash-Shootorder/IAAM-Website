    ...
    const fetchProduct = async () => {
      try {
        ...
        setFormData((prev) => ({
          ...prev,
          ...data,
          overviewSections: Array.isArray(data.overviewSections) 
            ? data.overviewSections 
            : (typeof data.overviewSections === 'string' ? (() => { try { return JSON.parse(data.overviewSections || '[]'); } catch { return []; } })() : []),
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-4">
              <h2 className="text-xl font-bold text-gray-900 mb-4">Key Benefits & Sections</h2>

              <OverviewSection
                sections={formData.overviewSections}
                onChange={(sections) =>
                  setFormData((prev) => ({ ...prev, overviewSections: sections }))
                }
              />
            ...
            <div className="bg-white rounded-lg shadow p-6 space-y-4">
              ...
              <div>
                ...
                >
                  ...
                  {formData.category && categories.find(cat => cat.name === formData.category)?.subcategories?.map((subcat) => (
